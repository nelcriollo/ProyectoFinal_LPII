	...
	<form id="idRegistrarMovimientoAlmacen" method="post" action="ServletMovimientoAlmacen?tipo=REGISTRAR" class="row mx-5 my-4">
		...
		<form class="row mx-5 my-3 p-3 border border-secondary">	
			...
			<div class="col-md-2 mb-2">
			  	<button class="btn btn-dark btn-nuevo m-1 mt-4 col-md-7 p-1" type="submit">Nuevo</button>		    
			</div>	
			<!-- Segundo nivel -->		
			<div class="col-md-3 mb-2">
			...
			<div class="col-md-7 mb-2">
			  	<label for="txtObservaciones" class="form-label">Observación</label>
		...
		<table id="example" class="table table-bordered table-hover mx-1 my-2 mb-3">
			...
			<tbody>
				<c:forEach items="${requestScope.listaMovimientoAlmacen}" var="row">
					...
					<td>${row.cod_bien}</td>
					<td>${row.cantidad}</td>
					<td>${row.descripcion_del_bien}</td>
					<td><button type="button" class="btn btn-success btn-editar" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Editar</button></td>
