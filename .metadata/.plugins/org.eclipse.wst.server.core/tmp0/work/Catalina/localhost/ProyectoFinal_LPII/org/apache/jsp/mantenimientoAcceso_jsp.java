 ...
 * Generated at: 2022-06-11 06:17:22 UTC
...
if (request.getSession().getAttribute("LISTAMenu") == null)
	response.sendRedirect("login.jsp");
      ...
      out.write("\t\t})\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tllenarcbosubmenu();\r\n");
      out.write("\t\tfunction llenarcbosubmenu(){\r\n");
      out.write("\t\t\t\tlet codmenu;\r\n");
      out.write("\t\t\t\tcodmenu=$(\"#idcodMenu\").val();\r\n");
      out.write("\t\t\t\t$(\"#idcodOpcionMemu\").empty();\r\n");
      out.write("\t\t\t\t$.get(\"ServletRolMenuJSON?rolesmenu=\"+codmenu,function(response){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tnotEmpty:{\r\n");
      out.write("\t\t\t\t\t\t\t\t        \t\t \t\t\t\tmessage:'Campo Código es obligatorio'\r\n");
      out.write("\t\t\t\t\t\t\t\t        \t\t \t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t        \t\t \t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t        \t\t \t\t\tregexp:{\r\n");
      out.write("\t\t\t\t\t\t\t\t        \t\t \t\t\t\tregexp:/^[0-9]{1,8}$/,\r\n");
      out.write("\t\t\t\t\t\t\t\t                                message:'Campo Código Solo debe ingresar 8 digitos'\r\n");
      out.write("\t\t\t\t\t\t\t\t        \t\t \t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tuser : {\r\n");
