...
<<<<<<< HEAD
<button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal">Genera Ficha de Devolución</button>
</div>
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
=======
<button type="button" class="btn btn-dark btn-generaFichaDevol" data-bs-toggle="modal" data-bs-target="#exampleModal">Genera Ficha de Devolución</button>
</div>
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
>>>>>>> NelsonCriollo
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Mantenimiento de Devolución</h5>
   ...
   <form id="IdRegistrarDevol" method="post" action="ServletBien?tipo=REGISTRAR"  class="form-horizontal border mt-1 mb-3">
	<div class="row mx-3 my-1">
				...
				<div class="col-md-6 text-center p-2 lh-sm">
					<br>
					<h6 class="fw-bolder">Registro de Devolución</h6>
=======
...
<<<<<<< HEAD
					<h5 class="fw-bolder">RUC:20401381291</h5>
					<h7>Ficha de Devolución</h7>
=======
					
					<h6 class="col-form-label fw-bolder">Ficha de Devolución</h6>
>>>>>>> NelsonCriollo
					<div class="row">
...
<div class="row p-3  mb-3">
  ...
  <div class="col-md-2">
    <label for="validationDefault02" class="form-label">Código de Bien</label>
 ...
 <div class="col-md-4">
  ...
  <div class="col-md-4">
    <label for="validationDefaultUsername" class="form-label">Crédito Adeudado</label>
    <div class="input-group">
      <span class="input-group-text" id="inputGroupPrepend2">S/.</span>
...
<div class="modal fade" id="modalVerDetalleDevolucion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Detalle  de Devolución</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
=======
	...
	<script
		...
		//cargarNumeroFichaDevol();
		 ...
		 //fuciones para obtener el núemro de ficha de devolución
		...
		//funcion para eliminar por código
		$(document).on("click", ".btn-outline-danger", function() {
			//variable
			let codigo;
			//obtener el código del Acceso según el botón eliminar que se a pulsado
			codigo = $(this).parents("tr").find("td")[0].innerHTML;
		...
		//})
			...
			//funcion para eliminar Detalle de devolución por código
