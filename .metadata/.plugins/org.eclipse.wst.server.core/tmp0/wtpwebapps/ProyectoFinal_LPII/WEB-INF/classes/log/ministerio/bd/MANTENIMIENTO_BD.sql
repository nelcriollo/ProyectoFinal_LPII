...
VALUES( _id_DetalleDevolucion,_id_Devolucion,_nro_orden_compra,_id_Bien,_descripcion_del_daño,_precioCompra,_cantidad,_credito_adeudado); 
END;
...
SET  nro_orden_compra=_nro_orden_compra,id_Bien=_id_Bien,descripcion_del_daño=_descripcion_del_daño,precioCompra=_precioCompra,cantidad=_cantidad,credito_adeudado=_credito_adeudado
...
BEGIN
SELECT DTDV.id_DetalleDevolucion,DEV.id_Devolucion,DEV.nro_ficha,OC.nro_orden_compra,TP.nombre,B.id_Bien,B.descripcion,DTDV.descripcion_del_daño,DTDV.precioCompra,DTDV.cantidad,DTDV.credito_adeudado
